...
namespace BasicESP
{
    class Player
    {
        ...
        private Frostbite.ClientSoldierReplication CSoldierReplication;        
        ...
        public Player(ulong playerPointer)
        {
            ...
            if (RPM.IsValid(CPlayer.m_AttachedControllable))
            {
                ...
                //CVehicleReplication = RPM.Read<Frostbite.ClientSoldierReplication>(CVehicle.m_SoldierPrediction);
                InVehicle = true;
            }

            CSoldierReplication = RPM.Read<Frostbite.ClientSoldierReplication>(CSoldier.m_SoldierPrediction);
